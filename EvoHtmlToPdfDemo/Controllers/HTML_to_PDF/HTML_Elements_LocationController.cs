...
{
    public class HTML_Elements_LocationController : Controller
    {
        private readonly Microsoft.AspNetCore.Hosting.IWebHostEnvironment m_hostingEnvironment;
        public HTML_Elements_LocationController(IWebHostEnvironment hostingEnvironment)
        {
        ...
        public ActionResult Select_in_API_Elements_to_Retrieve()
        {
            return View();
        }

        public ActionResult Select_in_HTML_Elements_to_Retrieve()
        {
            SetCurrentViewData();
