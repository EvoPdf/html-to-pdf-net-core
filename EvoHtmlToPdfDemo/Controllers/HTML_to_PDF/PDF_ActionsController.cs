...
{
    public class PDF_ActionsController : Controller
    {
        private readonly Microsoft.AspNetCore.Hosting.IWebHostEnvironment m_hostingEnvironment;
        public PDF_ActionsController(IWebHostEnvironment hostingEnvironment)
        {
        ...
        public ActionResult Execute_JavaScript_Open_Action()
        {
            return View();
        }

        public ActionResult Go_To_Page_Open_Action()
        {
            return View();
        }

        public ActionResult Execute_JavaScript_Button_Clicked()
        {
            SetCurrentViewData();
