...
{
    public class Avoid_Page_Breaks_Inside_HTML_Elements_Using_CSSController : Controller
    {
        [HttpPost]
        public ActionResult ConvertHtmlToPdf(IFormCollection collection)
        {
            ...
            fileResult.FileDownloadName = "Avoid_Page_Breaks_Inside_HTML_Elements_Using_CSS.pdf";
