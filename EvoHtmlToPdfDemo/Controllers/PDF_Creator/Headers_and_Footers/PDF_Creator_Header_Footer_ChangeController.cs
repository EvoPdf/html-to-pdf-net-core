...
{
    public class PDF_Creator_Header_Footer_ChangeController : Controller
    {
        IFormCollection formCollection;

        private readonly Microsoft.AspNetCore.Hosting.IWebHostEnvironment m_hostingEnvironment;
        public PDF_Creator_Header_Footer_ChangeController(IWebHostEnvironment hostingEnvironment)
        {
